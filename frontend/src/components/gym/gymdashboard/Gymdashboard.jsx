...
const Gymdashboard = () => {
  ...
  const serviceItems = {
    ...
    Accounts: [
      { title: "Bill", url: "/gym/bills"}, // ✅ Show StudentForm dynamically
    ...
    "Machine Maintenance": [
      { title: "Preventive", url: "/placement/selfrating" },
      { title: "Breakdown", url: "/profiles/edit" }
    ],
   Record: [
        { title: "Record", url: "/placement/opportunity/enquiry" },
       
      ],
     "Live Session": [
        { title: " Link", url: "/placement/opportunity/enquiry" },
        { title: "Own Space", url: "/placement/opportunity/apply" },
      ...
      Inventory: [
        { title: "Inventory", url: "/placement/opportunity/enquiry" },
