...
const approuter = createBrowserRouter([
  ...
  { path: "/mgtservice/mgtlibrary/seat", element: <SeatChart /> },
  { path: "/mgtservice/mgtlibrary/attendence", element: <Attendance /> },
  { path: "/mgtservice/mgtlibrary/account", element: <Account /> },
  { path: "/mgtservice/mgtlibrary/books", element: <Libshell /> },
  { path: "/mgtservice/mgtlibrary/bookloan", element: <LoanBook /> },
  {
  ...
  { path: "/library/smriti", element: <Smriti /> },
  { path: "/library/full", element: <Full /> },
  { path: "/diet", element: <DietChart /> },
  { path: "/placement", element: <Placement /> },
  { path: "/placement/opportunity", element: <Opportunity /> },
  { path: "/placement/opportunity/enquiry", element: <Enquiryplace /> },
  { path: "/placement/opportunity/apply", element: <ApplyPlac /> },
  { path: "/placement/opportunity/response", element: <ResopsePlace /> },
  { path: "/placement/resume", element: <Resume /> },
  { path: "/placement/selfrating", element: <Selfrating /> },
  { path: "/placement/resume/saved", element: <ResumeList /> },
  { path: "Sunnyairesume", element: <StudentForm /> },
  { path: "/placement/selfrating", element: <Selfrating /> },
  { path: "/service", element: <ServicePage /> },
  { path: "/service/activity/sports", element: <Sports /> },
  { path: "/service/activity/esports", element: <Esports /> },
  { path: "/service/activity/compition", element: <Competition /> },
  { path: "/service/exam/testseries", element: <Testseries /> },
  { path: "/service/exam/scholarship", element: <ScholarShip /> },
  { path: "/service/exam/apply", element: <Apply /> },
  { path: "/service/exam/result", element: <Results /> },
  { path: "/service/exam/studycenter", element: <StudyCenter /> },
  { path: "/service/exam/admitcard", element: <AdmitCard /> },
  { path: "/service/student", element: <StudentForm /> },
  { path: "/service/student/preview", element: <PreviewPage /> },
  { path: "/service/student/previewats", element: <PreviewPageAts /> },
  { path: "/profiles", element: <Profiles /> },

  { path: "/newsfeed", element: <NewsFeed /> },
  { path: "/library", element: <Library /> },
  { path: "/library/dashboard", element: <AddLibraryForm /> },
  { path: "/jobs", element: <Jobs /> },
  { path: "/compan", element: <Company /> },
  { path: "/company", element: <Comapnydashboard /> },
  { path: "/company/placement", element: <Companyplacement /> },
  ...
  { path: "/social", element: <SocialServicePage /> },
  { path: "/social/events", element: <Events /> },
  { path: "/lostnfound", element: <LostItem /> },

  { path: "/admin/companies", element: <Companies /> },
  { path: "/gym", element: <Gymdashboard /> },
  { path: "/gym/bills", element: <Bills /> },
  { path: "/gym/attendence", element: <GymAttendence /> },

  { path: "/gym/vayayam/training", element: <Trainingdashboard /> },
  { path: "/barber", element: <BarbarDashboard /> },
  { path: "/barber/attendence", element: <BarberAttendence /> },
  { path: "/ahar", element: <AharDashboard /> },
  { path: "/ahar/bill", element: <AharBills /> },
  { path: "/ahar/attendence", element: <AharAttendence /> },
]);
